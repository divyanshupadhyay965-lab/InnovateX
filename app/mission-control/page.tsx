...
import { problemDatabase } from "../explore/data/problemDatabase";
            ...
            >
              ...
              <div className="space-y-6 p-7">
                ...
                <button
                  ...
                  className="w-full rounded-2xl bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 py-4 text-lg font-black tracking-wider transition hover:scale-105"
                >
                  BEGIN OPERATION →
                </button>
              </div>
                ...
                <div className="mx-auto max-w-7xl space-y-10 px-10 py-12">
                  ...
                  <div className="rounded-3xl border border-cyan-500/20 bg-[#050b18] p-8">
                    ...
                    <div className="space-y-3 rounded-2xl bg-black p-6 font-mono text-green-400">
                      ...
                      <p>
                        &gt; Threat Level : {selectedMission.threat}%
                      </p>
                      <p>
                        &gt; Recommended Careers :{" "}
                        {selectedMission.careers.length}
                      </p>
                      <p>
                        &gt; Required Skills :{" "}
